...
Translations are downloaded from [github.com/jstadnik619/BibleDatabases](https://github.com/jstadnik619/BibleDatabases). Check the [available translations](https://github.com/jstadnik619/BibleDatabases?tab=readme-ov-file#available-translations) for more information. One or more translations may be downloaded. The first download is set as the default translation for the `reference` and `search` commands described below.
